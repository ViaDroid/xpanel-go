        ...
        <div border="0" cellpadding="0" cellspacing="0" width="100%" class="footer">
            <div>
                <div align="center" valign="top"
                     ...
                     class="brandInfo">
                    <p class="smlText">
                        <a href="{{index .config "baseUrl"}}" style="color:#505050;text-decoration:none"
                           target="_blank">{{index .config "appName"}}</a> |
                        <a href="{{index .config "baseUrl"}}/user/edit" style="color:#505050;text-decoration:none"

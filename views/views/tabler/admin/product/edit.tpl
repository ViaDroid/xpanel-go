                            ...
                            <div class="form-group mb-3 row">
                                ...
                                <div class="col">
                                    <select id="status" class="col form-select">
                                        <option value="1" {{if eq 1 .product.Status}}selected{{end}}>正常</option>
                                        <option value="0" {{if eq 0 .product.Status}}selected{{end}}>下架</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group mb-3 row">
                                ...
                                <div class="col">
                                    <select id="type" class="col form-select">
                                        <option value="tabp" {{if eq "tabp" .product.Type}}selected{{end}}>时间流量包
                                        </option>
                                        <option value="time" {{if eq "time" .product.Type}}selected{{end}}>时间包</option>
                                        <option value="bandwidth" {{if eq "bandwidth" .product.Type}}selected{{end}}>
                                            流量包
                                        </option>
                                    </select>
                                </div>
                                    ...
                                    <span class="col-auto">
                                        <label class="form-check form-check-single form-switch">
                                            <input id="new_user_required" class="form-check-input" type="checkbox"
                                                   {{if eq 1 .limit.NewUserRequired}}checked="" {{end}}>
                                        </label>
                                    </span>
                                </label>
                            </div>

                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane active show" id="gateway">
                                    {{range $key, $value := .payment_gateways}}
                                        <div class="form-group mb-3 row">
                                            <div class="row align-items-center">
                                                <label class="form-label col-3 col-form-label">{{$value}}</label>
                                                <label class="col-auto ms-auto form-check form-check-single form-switch">
                                                    <input id="{{$key}}_enable" class="form-check-input" type="checkbox"
                                                        {{$has := false}}
                                                        {{range $payGateway := $.active_payment_gateway}}
                                                            {{if czeq $key $payGateway}}
                                                                {{$has = true}}
                                                            {{end}}
                                                        {{end}}
                                                        {{if $has}}checked="" {{end}}>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="f2f_pay_app_id" type="text" class="form-control"
                                                       value="{{index .settings "f2f_pay_app_id"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="f2f_pay_pid" type="text" class="form-control"
                                                       value="{{index .settings "f2f_pay_pid"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="f2f_pay_public_key" type="text" class="form-control"
                                                       value="{{index .settings "f2f_pay_public_key"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="f2f_pay_private_key" type="text" class="form-control"
                                                       value="{{index .settings "f2f_pay_private_key"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="f2f_pay_notify_url" type="text" class="form-control"
                                                       value="{{index .settings "f2f_pay_notify_url"}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="stripe_card" class="col form-select"
                                                        value="{{index .settings "stripe_card"}}">
                                                    <option value="0">停用</option>
                                                    <option value="1" {{if (index .settings "stripe_card")}}selected{{end}}>启用
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="stripe_alipay" class="col form-select"
                                                        value="{{index .settings "stripe_alipay"}}">
                                                    <option value="0">停用</option>
                                                    <option value="1" {{if (index .settings "stripe_alipay")}}selected{{end}}>
                                                        启用
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="stripe_wechat" class="col form-select"
                                                        value="{{index .settings "stripe_wechat"}}">
                                                    <option value="0">停用</option>
                                                    <option value="1" {{if (index .settings "stripe_wechat")}}selected{{end}}>
                                                        启用
                                                    </option>
                                                </select>
                                            </div>
                                         ...
                                         <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="stripe_api_key" type="text" class="form-control"
                                                       value="{{index .settings "stripe_api_key"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="stripe_endpoint_secret" type="text" class="form-control"
                                                       value="{{index .settings "stripe_endpoint_secret"}}">
                                            </div>
                                            <div class="col-auto">
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="stripe_currency" type="text" class="form-control"
                                                       value="{{index .settings "stripe_currency"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="stripe_min_recharge" type="text" class="form-control"
                                                       value="{{index .settings "stripe_min_recharge"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="stripe_max_recharge" type="text" class="form-control"
                                                       value="{{index .settings "stripe_max_recharge"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="stripe_pk" type="text" class="form-control"
                                                       value="{{index .settings "stripe_pk"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="stripe_sk" type="text" class="form-control"
                                                       value="{{index .settings "stripe_sk"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="stripe_webhook_key" type="text" class="form-control"
                                                       value="{{index .settings "stripe_webhook_key"}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="epay_sign_type" type="text" class="form-control"
                                                       value="{{index .settings "epay_sign_type"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="epay_alipay" class="col form-select"
                                                        value="{{index .settings "epay_alipay"}}">
                                                    <option value="0">停用</option>
                                                    <option value="1" {{if (index .settings "epay_alipay")}}selected{{end}}>启用
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="epay_wechat" class="col form-select"
                                                        value="{{index .settings "epay_wechat"}}">
                                                    <option value="0">停用</option>
                                                    <option value="1" {{if (index .settings "epay_wechat")}}selected{{end}}>启用
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="epay_qq" class="col form-select"
                                                        value="{{index .settings "epay_qq"}}">
                                                    <option value="0">停用</option>
                                                    <option value="1" {{if (index .settings "epay_qq")}}selected{{end}}>启用
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="epay_usdt" class="col form-select"
                                                        value="{{index .settings "epay_usdt"}}">
                                                    <option value="0">停用</option>
                                                    <option value="1" {{if (index .settings "epay_usdt")}}selected{{end}}>启用
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="paypal_mode" class="col form-select"
                                                        value="{{index .settings "paypal_mode"}}">
                                                    <option value="sandbox">Sandbox</option>
                                                    <option value="live"
                                                            {{if czeq "live" (index .settings "paypal_mode")}}selected{{end}}>Live
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="paypal_client_id" type="text" class="form-control"
                                                       value="{{index .settings "paypal_client_id"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="paypal_client_secret" type="text" class="form-control"
                                                       value="{{index .settings "paypal_client_secret"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="paypal_currency" type="text" class="form-control"
                                                       value="{{index .settings "paypal_currency"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="paypal_locale" type="text" class="form-control"
                                                       value="{{index .settings "paypal_locale"}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>

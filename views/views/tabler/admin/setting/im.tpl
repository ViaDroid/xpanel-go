                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="telegram_add_node" class="col form-select"
                                                        value="{{index .settings "telegram_add_node"}}">
                                                    <option value="0"
                                                            {{if not (index .settings "telegram_add_node")}}selected{{end}}>关闭
                                                    </option>
                                                    <option value="1" {{if (index .settings "telegram_add_node")}}selected{{end}}>
                                                        开启
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="telegram_add_node_text" type="text" class="form-control"
                                                       value="{{index .settings "telegram_add_node_text"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="telegram_update_node" class="col form-select"
                                                        value="{{index .settings "telegram_update_node"}}">
                                                    <option value="0"
                                                            {{if not (index .settings "telegram_update_node")}}selected{{end}}>关闭
                                                    </option>
                                                    <option value="1"
                                                            {{if (index .settings "telegram_update_node")}}selected{{end}}>开启
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="telegram_update_node_text" type="text" class="form-control"
                                                       value="{{index .settings "telegram_update_node_text"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="telegram_delete_node" class="col form-select"
                                                        value="{{index .settings "telegram_delete_node"}}">
                                                    <option value="0"
                                                            {{if not (index .settings "telegram_delete_node")}}selected{{end}}>关闭
                                                    </option>
                                                    <option value="1"
                                                            {{if (index .settings "telegram_delete_node")}}selected{{end}}>开启
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="telegram_delete_node_text" type="text" class="form-control"
                                                       value="{{index .settings "telegram_delete_node_text"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="telegram_node_gfwed" class="col form-select"
                                                        value="{{index .settings "telegram_node_gfwed"}}">
                                                    <option value="0"
                                                            {{if not (index .settings "telegram_node_gfwed")}}selected{{end}}>关闭
                                                    </option>
                                                    <option value="1"
                                                            {{if (index .settings "telegram_node_gfwed")}}selected{{end}}>开启
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="telegram_node_gfwed_text" type="text" class="form-control"
                                                       value="{{index .settings "telegram_node_gfwed_text"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="telegram_node_ungfwed" class="col form-select"
                                                        value="{{index .settings "telegram_node_ungfwed"}}">
                                                    <option value="0"
                                                            {{if not (index .settings "telegram_node_ungfwed")}}selected{{end}}>关闭
                                                    </option>
                                                    <option value="1"
                                                            {{if (index .settings "telegram_node_ungfwed")}}selected{{end}}>开启
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="telegram_node_ungfwed_text" type="text" class="form-control"
                                                       value="{{index .settings "telegram_node_ungfwed_text"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="telegram_node_offline" class="col form-select"
                                                        value="{{index .settings "telegram_node_offline"}}">
                                                    <option value="0"
                                                            {{if not (index .settings "telegram_node_offline")}}selected{{end}}>关闭
                                                    </option>
                                                    <option value="1"
                                                            {{if (index .settings "telegram_node_offline")}}selected{{end}}>开启
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="telegram_node_offline_text" type="text" class="form-control"
                                                       value="{{index .settings "telegram_node_offline_text"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="telegram_node_online" class="col form-select"
                                                        value="{{index .settings "telegram_node_online"}}">
                                                    <option value="0"
                                                            {{if not (index .settings "telegram_node_online")}}selected{{end}}>关闭
                                                    </option>
                                                    <option value="1"
                                                            {{if (index .settings "telegram_node_online")}}selected{{end}}>开启
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="telegram_node_online_text" type="text" class="form-control"
                                                       value="{{index .settings "telegram_node_online_text"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="telegram_daily_job" class="col form-select"
                                                        value="{{index .settings "telegram_daily_job"}}">
                                                    <option value="0"
                                                            {{if not (index .settings "telegram_daily_job")}}selected{{end}}>关闭
                                                    </option>
                                                    <option value="1" {{if (index .settings "telegram_daily_job")}}selected{{end}}>
                                                        开启
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="telegram_daily_job_text" type="text" class="form-control"
                                                       value="{{index .settings "telegram_daily_job_text"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="telegram_diary" class="col form-select"
                                                        value="{{index .settings "telegram_diary"}}">
                                                    <option value="0" {{if not (index .settings "telegram_diary")}}selected{{end}}>
                                                        关闭
                                                    </option>
                                                    <option value="1" {{if (index .settings "telegram_diary")}}selected{{end}}>
                                                        开启
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="telegram_diary_text" type="text" class="form-control"
                                                       value="{{index .settings "telegram_diary_text"}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="enable_telegram" class="col form-select"
                                                        value="{{index .settings "enable_telegram"}}">
                                                    <option value="0" {{if not (index .settings "enable_telegram")}}selected{{end}}>
                                                        关闭
                                                    </option>
                                                    <option value="1" {{if (index .settings "enable_telegram")}}selected{{end}}>
                                                        开启
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="telegram_token" type="text" class="form-control"
                                                       value="{{index .settings "telegram_token"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="telegram_chatid" type="text" class="form-control"
                                                       value="{{index .settings "telegram_chatid"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="telegram_bot" type="text" class="form-control"
                                                       value="{{index .settings "telegram_bot"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="telegram_request_token" type="text" class="form-control"
                                                       value="{{index .settings "telegram_request_token"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="telegram_unbind_kick_member" class="col form-select"
                                                        value="{{index .settings "telegram_unbind_kick_member"}}">
                                                    <option value="0"
                                                            {{if not (index .settings "telegram_unbind_kick_member")}}selected{{end}}>
                                                        关闭
                                                    </option>
                                                    <option value="1"
                                                            {{if (index .settings "telegram_unbind_kick_member")}}selected{{end}}>
                                                        开启
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="telegram_group_bound_user" class="col form-select"
                                                        value="{{index .settings "telegram_group_bound_user"}}">
                                                    <option value="0"
                                                            {{if not (index .settings "telegram_group_bound_user")}}selected{{end}}>
                                                        关闭
                                                    </option>
                                                    <option value="1"
                                                            {{if (index .settings "telegram_group_bound_user")}}selected{{end}}>开启
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="enable_welcome_message" class="col form-select"
                                                        value="{{index .settings "enable_welcome_message"}}">
                                                    <option value="0"
                                                            {{if not (index .settings "enable_welcome_message")}}selected{{end}}>关闭
                                                    </option>
                                                    <option value="1"
                                                            {{if (index .settings "enable_welcome_message")}}selected{{end}}>开启
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="telegram_group_quiet" class="col form-select"
                                                        value="{{index .settings "telegram_group_quiet"}}">
                                                    <option value="0"
                                                            {{if not (index .settings "telegram_group_quiet")}}selected{{end}}>关闭
                                                    </option>
                                                    <option value="1"
                                                            {{if (index .settings "telegram_group_quiet")}}selected{{end}}>开启
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="allow_to_join_new_groups" class="col form-select"
                                                        value="{{index .settings "allow_to_join_new_groups"}}">
                                                    <option value="0"
                                                            {{if not (index .settings "allow_to_join_new_groups")}}selected{{end}}>关闭
                                                    </option>
                                                    <option value="1"
                                                            {{if (index .settings "allow_to_join_new_groups")}}selected{{end}}>开启
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="group_id_allowed_to_join" type="text" class="form-control"
                                                       value="{{index .settings "group_id_allowed_to_join"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="help_any_command" class="col form-select"
                                                        value="{{index .settings "help_any_command"}}">
                                                    <option value="0" {{if not (index .settings "help_any_command")}}selected{{end}}>
                                                        关闭
                                                    </option>
                                                    <option value="1" {{if (index .settings "help_any_command")}}selected{{end}}>
                                                        开启
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="user_not_bind_reply" type="text" class="form-control"
                                                       value="{{index .settings "user_not_bind_reply"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="discord_bot_token" type="text" class="form-control"
                                                       value="{{index .settings "discord_bot_token"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="discord_client_id" type="text" class="form-control"
                                                       value="{{index .settings "discord_client_id"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="discord_client_secret" type="text" class="form-control"
                                                       value="{{index .settings "discord_client_secret"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="discord_guild_id" type="text" class="form-control"
                                                       value="{{index .settings "discord_guild_id"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="slack_token" type="text" class="form-control"
                                                       value="{{index .settings "slack_token"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            <label class="form-label col-3 col-form-label">Client ID</label>
                                            <div class="col">
                                                <input id="slack_client_id" type="text" class="form-control"
                                                       value="{{index .settings "slack_client_id"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            <label class="form-label col-3 col-form-label">Client Secret</label>
                                            <div class="col">
                                                <input id="slack_client_secret" type="text" class="form-control"
                                                       value="{{index .settings "slack_client_secret"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="slack_team_id" type="text" class="form-control"
                                                       value="{{index .settings "slack_team_id"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">

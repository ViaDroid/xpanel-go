                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="email_driver" class="col form-select"
                                                        value="{{index .settings "email_driver"}}">
                                                    <option value="none"
                                                            {{if czeq "none" (index .settings "email_driver")}}selected{{end}}>none
                                                    </option>
                                                    <option value="smtp"
                                                            {{if czeq "smtp" (index .settings "email_driver")}}selected{{end}}>smtp
                                                    </option>
                                                    <option value="mailgun"
                                                            {{if czeq "mailgun" (index .settings "email_driver")}}selected{{end}}>
                                                        mailgun
                                                    </option>
                                                    <option value="sendgrid"
                                                            {{if czeq "sendgrid" (index .settings "email_driver")}}selected{{end}}>
                                                        sendgrid
                                                    </option>
                                                    <option value="postal"
                                                            {{if czeq "postal" (index .settings "email_driver")}}selected{{end}}>
                                                        postal
                                                    </option>
                                                    <option value="ses"
                                                            {{if czeq "ses" (index .settings "email_driver")}}selected{{end}}>ses
                                                    </option>
                                                    <option value="mailchimp"
                                                            {{if czeq "mailchimp" (index .settings "email_driver")}}selected{{end}}>ses
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="email_verify_code_ttl" type="text" class="form-control"
                                                       value="{{index .settings "email_verify_code_ttl"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="email_password_reset_ttl" type="text" class="form-control"
                                                       value="{{index .settings "email_password_reset_ttl"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="email_request_ip_limit" type="text" class="form-control"
                                                       value="{{index .settings "email_request_ip_limit"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="email_request_address_limit" type="text" class="form-control"
                                                       value="{{index .settings "email_request_address_limit"}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="smtp_host" type="text" class="form-control"
                                                       value="{{index .settings "smtp_host"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="smtp_username" type="text" class="form-control"
                                                       value="{{index .settings "smtp_username"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="smtp_password" type="text" class="form-control"
                                                       value="{{index .settings "smtp_password"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="smtp_port" class="col form-select"
                                                        value="{{index .settings "smtp_port"}}">
                                                    <option value="465"
                                                            {{if czeq "465" (index .settings "smtp_port")}}selected{{end}}>465
                                                    </option>
                                                    <option value="587"
                                                            {{if czeq "587" (index .settings "smtp_port")}}selected{{end}}>587
                                                    </option>
                                                    <option value="443"
                                                            {{if czeq "443" (index .settings "smtp_port")}}selected{{end}}>443
                                                    </option>
                                                    <option value="80"
                                                            {{if czeq "80" (index .settings "smtp_port")}}selected{{end}}>80
                                                    </option>
                                                    <option value="2525"
                                                            {{if czeq "2525" (index .settings "smtp_port")}}selected{{end}}>2525
                                                    </option>
                                                    <option value="25"
                                                            {{if czeq "25" (index .settings "smtp_port")}}selected{{end}}>25
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="smtp_name" type="text" class="form-control"
                                                       value="{{index .settings "smtp_name"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="smtp_sender" type="text" class="form-control"
                                                       value="{{index .settings "smtp_sender"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="smtp_ssl" class="col form-select"
                                                        value="{{index .settings "smtp_ssl"}}">
                                                    <option value="0" {{if not (index .settings "smtp_ssl")}}selected{{end}}>关闭
                                                    </option>
                                                    <option value="1" {{if (index .settings "smtp_ssl")}}selected{{end}}>开启
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="mailgun_key" type="text" class="form-control"
                                                       value="{{index .settings "mailgun_key"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="mailgun_domain" type="text" class="form-control"
                                                       value="{{index .settings "mailgun_domain"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="mailgun_sender" type="text" class="form-control"
                                                       value="{{index .settings "mailgun_sender"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="mailgun_sender_name" type="text" class="form-control"
                                                       value="{{index .settings "mailgun_sender_name"}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="sendgrid_key" type="text" class="form-control"
                                                       value="{{index .settings "sendgrid_key"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="sendgrid_sender" type="text" class="form-control"
                                                       value="{{index .settings "sendgrid_sender"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="sendgrid_name" type="text" class="form-control"
                                                       value="{{index .settings "sendgrid_name"}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="postal_host" type="text" class="form-control"
                                                       value="{{index .settings "postal_host"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="postal_key" type="text" class="form-control"
                                                       value="{{index .settings "postal_key"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="postal_sender" type="text" class="form-control"
                                                       value="{{index .settings "postal_sender"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="postal_name" type="text" class="form-control"
                                                       value="{{index .settings "postal_name"}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="aws_access_key_id" type="text" class="form-control"
                                                       value="{{index .settings "aws_access_key_id"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="aws_secret_access_key" type="text" class="form-control"
                                                       value="{{index .settings "aws_secret_access_key"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="aws_region" type="text" class="form-control"
                                                       value="{{index .settings "aws_region"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="aws_ses_sender" type="text" class="form-control"
                                                       value="{{index .settings "aws_ses_sender"}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="mailchimp_key" type="text" class="form-control"
                                                       value="{{index .settings "mailchimp_key"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="mailchimp_from_email" type="text" class="form-control"
                                                       value="{{index .settings "mailchimp_from_email"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="mailchimp_from_name" type="text" class="form-control"
                                                       value="{{index .settings "mailchimp_from_name"}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>

                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="enable_ss_sub" class="col form-select"
                                                        value="{{index .settings "enable_ss_sub"}}">
                                                    <option value="0" {{if not (index .settings "enable_ss_sub")}}selected{{end}}>
                                                        关闭
                                                    </option>
                                                    <option value="1" {{if (index .settings "enable_ss_sub")}}selected{{end}}>
                                                        开启
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="enable_v2_sub" class="col form-select"
                                                        value="{{index .settings "enable_v2_sub"}}">
                                                    <option value="0" {{if not (index .settings "enable_v2_sub")}}selected{{end}}>
                                                        关闭
                                                    </option>
                                                    <option value="1" {{if (index .settings "enable_v2_sub")}}selected{{end}}>
                                                        开启
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="enable_trojan_sub" class="col form-select"
                                                        value="{{index .settings "enable_trojan_sub"}}">
                                                    <option value="0"
                                                            {{if not (index .settings "enable_trojan_sub")}}selected{{end}}>关闭
                                                    </option>
                                                    <option value="1" {{if (index .settings "enable_trojan_sub")}}selected{{end}}>
                                                        开启
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="enable_forced_replacement" class="col form-select"
                                                        value="{{index .settings "enable_forced_replacement"}}">
                                                    <option value="0"
                                                            {{if not (index .settings "enable_forced_replacement")}}selected{{end}}>
                                                        关闭
                                                    </option>
                                                    <option value="1"
                                                            {{if (index .settings "enable_forced_replacement")}}selected{{end}}>开启
                                                    </option>
                                                </select>
                                            </div>
                                        </div>

                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="reg_mode" class="col form-select"
                                                        value="{{index .settings "reg_mode"}}">
                                                    <option value="close"
                                                            {{if czeq "close" (index .settings "reg_mode")}}selected{{end}}>关闭注册
                                                    </option>
                                                    <option value="open"
                                                            {{if czeq "open" (index .settings "reg_mode")}}selected{{end}}>公开注册
                                                    </option>
                                                    <option value="invite"
                                                            {{if czeq "invite" (index .settings "reg_mode")}}selected{{end}}>
                                                        仅限用户邀请注册
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="reg_email_verify" class="col form-select"
                                                        value="{{index .settings "reg_email_verify"}}">
                                                    <option value="0" {{if not (index .settings "reg_email_verify")}}selected{{end}}>
                                                        关闭
                                                    </option>
                                                    <option value="1" {{if (index .settings "reg_email_verify")}}selected{{end}}>
                                                        开启
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="reg_daily_report" class="col form-select"
                                                        value="{{index .settings "reg_daily_report"}}">
                                                    <option value="0"
                                                            {{if not (index .settings "reg_daily_report")}}selected{{end}}>关闭
                                                    </option>
                                                    <option value="1"
                                                            {{if (index .settings "reg_daily_report")}}selected{{end}}>开启
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="random_group" type="text" class="form-control"
                                                       value="{{index .settings "random_group"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="reg_traffic" type="text" class="form-control"
                                                       value="{{index .settings "reg_traffic"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="free_user_reset_day" type="text" class="form-control"
                                                       value="{{index .settings "free_user_reset_day"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="free_user_reset_bandwidth" type="text" class="form-control"
                                                       value="{{index .settings "free_user_reset_bandwidth"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="reg_class" type="text" class="form-control"
                                                       value="{{index .settings "reg_class"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="reg_class_time" type="text" class="form-control"
                                                       value="{{index .settings "reg_class_time"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="reg_method" type="text" class="form-control"
                                                       value="{{index .settings "reg_method"}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="reg_ip_limit" type="text" class="form-control"
                                                       value="{{index .settings "reg_ip_limit"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="reg_speed_limit" type="text" class="form-control"
                                                       value="{{index .settings "reg_speed_limit"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="reg_forbidden_ip" type="text" class="form-control"
                                                       value="{{index .settings "reg_forbidden_ip"}}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="reg_forbidden_port" type="text" class="form-control"
                                                       value="{{index .settings "reg_forbidden_port"}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>

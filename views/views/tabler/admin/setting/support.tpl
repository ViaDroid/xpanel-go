                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="live_chat" class="col form-select"
                                                        value="{{index .settings "live_chat"}}">
                                                    <option value="none"
                                                            {{if czeq "none" (index .settings "live_chat")}}selected{{end}}>无
                                                    </option>
                                                    <option value="crisp"
                                                            {{if czeq "crisp" (index .settings "live_chat")}}selected{{end}}>Crisp
                                                    </option>
                                                    <option value="livechat"
                                                            {{if czeq "livechat" (index .settings "live_chat")}}selected{{end}}>
                                                        LiveChat
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="livechat_license" type="text" class="form-control"
                                                       value="{{index .settings "livechat_license"}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="enable_ticket" class="col form-select"
                                                        value="{{index .settings "enable_ticket"}}">
                                                    <option value="0" {{if not (index .settings "enable_ticket")}}selected{{end}}>
                                                        关闭
                                                    </option>
                                                    <option value="1" {{if (index .settings "enable_ticket")}}selected{{end}}>
                                                        开启
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select id="mail_ticket" class="col form-select"
                                                        value="{{index .settings "mail_ticket"}}">
                                                    <option value="0" {{if not (index .settings "mail_ticket")}}selected{{end}}>
                                                        关闭
                                                    </option>
                                                    <option value="1" {{if (index .settings "mail_ticket")}}selected{{end}}>开启
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="ticket_limit" type="text" class="form-control"
                                                       value="{{index .settings "ticket_limit"}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>

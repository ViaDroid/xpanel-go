{{if czeq "crisp" (index .public_setting "live_chat")}}   
    <script>
        window.$crisp = [];
        ...
        $crisp.push(["set", "user:nickname", "{{.user.user_name}}"],
            ...
            ["set", "session:data",
                [[
                    ...
                    ["available_traffic", "{{.user.unusedTraffic__}}"],
                    ["balance", "{{.user.money}}"]
                ]]
            ]);
    </script>
...
{{if czeq "livechat" (index .public_setting "live_chat")}}
    <script>
        window.__lc = window.__lc ||
        {
        };
        window.__lc.license = "{{index .public_setting "livechat_license"}}";
        window.__lc.params = [
            {
            ...
            {
                name: '剩余流量', value: '{{.user.unusedTraffic__}}'
            },
            {
